...
export function Blogs() {
  return (
    <CollectionPage collectionName="blogs" title="Blogs" icon={FileText} color="#6366f1"
      fields={[
        { key:"sno", label:"S.No" }, { key:"date", label:"Date", type:"date" },
      ...
      tableColumns={[{ key:"date", label:"Date" },{ key:"title", label:"Title" },{ key:"tags", label:"Tags" }]}
    />
  );
}
...
export function Carousels() {
  return (
    <CollectionPage collectionName="carousels" title="Carousels" icon={Images} color="#06b6d4"
      fields={[
        { key:"sno", label:"S.No" }, { key:"date", label:"Date", type:"date" },
        { key:"title", label:"Title", span:2 },
        { key:"prompt", label:"Prompt", type:"textarea", span:2 },
...
export function Reels() {
  return (
    <CollectionPage collectionName="reels" title="Reels" icon={Film} color="#8b5cf6"
      fields={[
        { key:"sno", label:"S.No" }, { key:"date", label:"Date", type:"date" },
        { key:"title", label:"Title", span:2 },
      ...
      tableColumns={[{ key:"date", label:"Date" },{ key:"title", label:"Title" },{ key:"captionTags", label:"Caption/Tags" }]}
    />
  );
}
...
export function Media() {
  return (
    <CollectionPage collectionName="media" title="Podcast / YouTube" icon={Mic} color="#f43f5e"
      fields={[
        { key:"sno", label:"S.No" },
      ...
      tableColumns={[{ key:"date", label:"Date" },{ key:"title", label:"Title" },{ key:"captionTitleTags", label:"Caption/Tags" }]}
    />
  );
}
...
export function Tweets() {
  return (
    <CollectionPage collectionName="tweets" title="Tweets" icon={MessageCircle} color="#0ea5e9"
      fields={[
        { key:"sno", label:"S.No" }, { key:"date", label:"Date", type:"date" },
      ...
      platforms={["response"]}
      tableColumns={[{ key:"date", label:"Date" },{ key:"tweet", label:"Tweet" },{ key:"tags", label:"Tags" }]}
    />
  );
}
